            ...
            if (_hx_local_0 == 5):
                ...
                if (_g == "include"):
                    ...
                    if sys_FileSystem.exists(xmlPath):
                        ...
                        haxe_Log.trace(("include xml parsing:" + ("null" if xmlPath is None else xmlPath)),_hx_AnonObject({'fileName': "src/Build.hx", 'lineNumber': 281, 'className': "Build", 'methodName': "action"}))
