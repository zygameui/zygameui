...
class Tools:
    ...
    def main():
        ...
        haxe_Log.trace("authorization=",_hx_AnonObject({'fileName': "src/Tools.hx", 'lineNumber': 52, 'className': "Tools", 'methodName': "main", 'customParams': [authorization]}))
        haxe_Log.trace(("haxelib:" + HxOverrides.stringOrNull(Tools.haxelib)),_hx_AnonObject({'fileName': "src/Tools.hx", 'lineNumber': 53, 'className': "Tools", 'methodName': "main"}))
        haxe_Log.trace(("args:" + Std.string(Sys.args())),_hx_AnonObject({'fileName': "src/Tools.hx", 'lineNumber': 54, 'className': "Tools", 'methodName': "main"}))
        args = Sys.args()
        if (len(args) == 1):
            haxe_Log.trace(("version:" + HxOverrides.stringOrNull(Tools.version)),_hx_AnonObject({'fileName': "src/Tools.hx", 'lineNumber': 57, 'className': "Tools", 'methodName': "main"}))
            haxe_Log.trace("帮助列表：\n            -inittask 初始化VSCODE的task.json文件\n            -build 用于生成不同平台命令（通用）\n            -upload 库名 秘钥 :用于上传相关的库到自开发库中（需要得到授权才能够更新到自开发库）\n            -updatedev 库名 :用于下载线上最新的版本到haxelib开发版本中（需要得到授权才能够更新到自开发库）\n            -updatelib :用于更新所有的自有开发库（需要得到授权才能够更新到自开发库）\n            -libs :显示所有库版本情况（需要得到授权）",_hx_AnonObject({'fileName': "src/Tools.hx", 'lineNumber': 58, 'className': "Tools", 'methodName': "main"}))
            return
        ...
        if (_hx_local_1 == 10):
            ...
            if (command1 == "-atf"):
                ...
                haxe_Log.trace("Mp3 to Ogg...",_hx_AnonObject({'fileName': "src/Tools.hx", 'lineNumber': 104, 'className': "Tools", 'methodName': "main", 'customParams': [Sys.getCwd()]}))
    ...
    def showLibs():
        ...
        haxe_Log.trace("\n版本库：",_hx_AnonObject({'fileName': "src/Tools.hx", 'lineNumber': 111, 'className': "Tools", 'methodName': "showLibs"}))
            ...
            if (len(a) == 2):
                ...
                if sys_FileSystem.exists(((HxOverrides.stringOrNull(Tools.haxelib) + "/") + ("null" if projectName is None else projectName))):
                    if sys_FileSystem.exists((((HxOverrides.stringOrNull(Tools.haxelib) + "/") + ("null" if projectName is None else projectName)) + "/.current")):
                        haxe_Log.trace(((("null" if lib is None else lib) + "  now:") + HxOverrides.stringOrNull(sys_io_File.getContent((((HxOverrides.stringOrNull(Tools.haxelib) + "/") + ("null" if projectName is None else projectName)) + "/.current")))),_hx_AnonObject({'fileName': "src/Tools.hx", 'lineNumber': 119, 'className': "Tools", 'methodName': "showLibs"}))
                    elif sys_FileSystem.exists((((HxOverrides.stringOrNull(Tools.haxelib) + "/") + ("null" if projectName is None else projectName)) + "/.dev")):
                        haxe_Log.trace((("null" if lib is None else lib) + "  now:开发版本"),_hx_AnonObject({'fileName': "src/Tools.hx", 'lineNumber': 121, 'className': "Tools", 'methodName': "showLibs"}))
                    else:
                        haxe_Log.trace((("null" if lib is None else lib) + "  now:库已损坏"),_hx_AnonObject({'fileName': "src/Tools.hx", 'lineNumber': 123, 'className': "Tools", 'methodName': "showLibs"}))
                else:
                    haxe_Log.trace((("null" if lib is None else lib) + "  now:库不存在"),_hx_AnonObject({'fileName': "src/Tools.hx", 'lineNumber': 126, 'className': "Tools", 'methodName': "showLibs"}))
    ...
    def updateLib():
        ...
        while (_g < len(versoins)):
            ...
            haxe_Log.trace(("检查库：" + Std.string((arr[0] if 0 < len(arr) else None))),_hx_AnonObject({'fileName': "src/Tools.hx", 'lineNumber': 157, 'className': "Tools", 'methodName': "updateLib"}))
            ...
            if sys_FileSystem.exists(cheakVersionPath):
                ...
                haxe_Log.trace(("curVersion:" + ("null" if curVersion is None else curVersion)),_hx_AnonObject({'fileName': "src/Tools.hx", 'lineNumber': 162, 'className': "Tools", 'methodName': "updateLib"}))
                ...
                if (curVersion != python_internal_ArrayImpl._get((arr[0] if 0 < len(arr) else None), 1)):
                    ...
                    tmp = False
                if tmp:
                    haxe_Log.trace("版本有更新，开始下载",_hx_AnonObject({'fileName': "src/Tools.hx", 'lineNumber': 165, 'className': "Tools", 'methodName': "updateLib"}))
                    isUpdate = True
                else:
                    haxe_Log.trace("已是最新无需更新",_hx_AnonObject({'fileName': "src/Tools.hx", 'lineNumber': 168, 'className': "Tools", 'methodName': "updateLib"}))
            elif sys_FileSystem.exists(cheakDevPath):
                haxe_Log.trace(("newVersion:" + HxOverrides.stringOrNull(python_internal_ArrayImpl._get((arr[0] if 0 < len(arr) else None), 1))),_hx_AnonObject({'fileName': "src/Tools.hx", 'lineNumber': 171, 'className': "Tools", 'methodName': "updateLib"}))
                haxe_Log.trace("该库为开发库",_hx_AnonObject({'fileName': "src/Tools.hx", 'lineNumber': 172, 'className': "Tools", 'methodName': "updateLib"}))
            else:
                haxe_Log.trace("库不存在，开始下载",_hx_AnonObject({'fileName': "src/Tools.hx", 'lineNumber': 174, 'className': "Tools", 'methodName': "updateLib"}))
                isUpdate = True
            if isUpdate:
                haxe_Log.trace((((((((("null" if downloadPath is None else downloadPath) + "haxelib/") + HxOverrides.stringOrNull(python_internal_ArrayImpl._get((arr[0] if 0 < len(arr) else None), 0))) + HxOverrides.stringOrNull(python_internal_ArrayImpl._get((arr[0] if 0 < len(arr) else None), 1))) + ".zip") + " -> ") + HxOverrides.stringOrNull(python_internal_ArrayImpl._get((arr[0] if 0 < len(arr) else None), 0))) + ".zip"),_hx_AnonObject({'fileName': "src/Tools.hx", 'lineNumber': 180, 'className': "Tools", 'methodName': "updateLib"}))
    ...
    def updatedev():
        ...
        haxe_Log.trace(("正在更新库：" + ("null" if projectName is None else projectName)),_hx_AnonObject({'fileName': "src/Tools.hx", 'lineNumber': 202, 'className': "Tools", 'methodName': "updatedev"}))
        if sys_FileSystem.exists((((HxOverrides.stringOrNull(Tools.haxelib) + "/") + ("null" if projectName is None else projectName)) + "/.dev")):
            ...
            while (_g < _g1):
                ...
                if (((lib.find(projectName) if ((startIndex is None)) else HxString.indexOfImpl(lib,projectName,startIndex))) != -1):
                    ...
                    haxe_Log.trace(((("正在更新" + ("null" if lib is None else lib)) + ":") + ("null" if downloadPath is None else downloadPath)),_hx_AnonObject({'fileName': "src/Tools.hx", 'lineNumber': 210, 'className': "Tools", 'methodName': "updatedev"}))
                    ...
                    haxe_Log.trace("同步版本",_hx_AnonObject({'fileName': "src/Tools.hx", 'lineNumber': 214, 'className': "Tools", 'methodName': "updatedev"}))
                    ...
                    haxe_Log.trace("更新结束！",_hx_AnonObject({'fileName': "src/Tools.hx", 'lineNumber': 219, 'className': "Tools", 'methodName': "updatedev"}))
                    break
        else:
            haxe_Log.trace((("null" if projectName is None else projectName) + "不是你的开发库，无法更新"),_hx_AnonObject({'fileName': "src/Tools.hx", 'lineNumber': 224, 'className': "Tools", 'methodName': "updatedev"}))
    ...
    def uploadlib():
        ...
        haxe_Log.trace(("正在处理项目库：" + ("null" if projectPath is None else projectPath)),_hx_AnonObject({'fileName': "src/Tools.hx", 'lineNumber': 232, 'className': "Tools", 'methodName': "uploadlib"}))
        if sys_FileSystem.exists(projectPath):
            ...
            haxe_Log.trace(("升级版本至：" + ("null" if v is None else v)),_hx_AnonObject({'fileName': "src/Tools.hx", 'lineNumber': 245, 'className': "Tools", 'methodName': "uploadlib"}))
            onlineVersion = sys_Http.requestUrl(((HxOverrides.stringOrNull(Tools.webPath) + "haxelib/version.json?") + Std.string(python_lib_Random.random())))
            startIndex = None
            ...
            while (_g < _g1):
                ...
                if (((lib.find(projectName) if ((startIndex is None)) else HxString.indexOfImpl(lib,projectName,startIndex))) != -1):
                    ...
                    haxe_Log.trace((((("线上版本：" + ("null" if onlineV is None else onlineV)) + "->") + " 当前新版本：") + ("null" if v is None else v)),_hx_AnonObject({'fileName': "src/Tools.hx", 'lineNumber': 257, 'className': "Tools", 'methodName': "uploadlib"}))
                    if (Std.parseInt(StringTools.replace(onlineV,".","")) >= Std.parseInt(StringTools.replace(v,".",""))):
                        haxe_Log.trace("你的本地版本需大于线上版本",_hx_AnonObject({'fileName': "src/Tools.hx", 'lineNumber': 260, 'className': "Tools", 'methodName': "uploadlib"}))
                        exit(1)
                    ...
                    haxe_Log.trace("开始上传",_hx_AnonObject({'fileName': "src/Tools.hx", 'lineNumber': 295, 'className': "Tools", 'methodName': "uploadlib"}))
                    ...
                    haxe_Log.trace("上传成功：",_hx_AnonObject({'fileName': "src/Tools.hx", 'lineNumber': 299, 'className': "Tools", 'methodName': "uploadlib", 'customParams': [projectName, v]}))
                    sys_FileSystem.deleteFile((((("null" if projectPath is None else projectPath) + "/../") + ("null" if projectName is None else projectName)) + ".zip"))
                    break
        else:
            haxe_Log.trace("库不存在！",_hx_AnonObject({'fileName': "src/Tools.hx", 'lineNumber': 305, 'className': "Tools", 'methodName': "uploadlib"}))
    ...
    def uploadOSS(file,saveName):
        ...
        haxe_Log.trace(command,_hx_AnonObject({'fileName': "src/Tools.hx", 'lineNumber': 311, 'className': "Tools", 'methodName': "uploadOSS"}))
        Sys.command(command)
