...
class BButton extends BToggleButton{
     ...
     * @return BButton
     */
    public static function createScale9Button(sprites:TextureAtlas, width:Float, height:Float, up:Frame,down:Frame = null,over:Frame = null,out:Frame = null):BScale9Button
    {
