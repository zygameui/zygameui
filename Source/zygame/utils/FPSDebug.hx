	...
	{	
		...
		{	
            ...
            if(debugMsg != null)
			    ...
			    _text.dataProvider = "MODE:"+Lib.getRenderMode()+"_MEM:" + mem + "MB_MaxMEN:" + memPeak + "MB_UPDATES:"+ zygame.core.Start.current.getUpdateLength() + "_SUPDATES:" + SpineManager.count() + "_FPS:" + getFps() + "_DrawCalls:"+(_curDrawCall - 2) #if html5 + "_Texture:" + zygame.core.Start.TEXTURE_COUNT  #end  #if wechat + "_Context:" + untyped window.contextCount + "_Image:" + untyped window.imageCount #end ;	
        }
    }
