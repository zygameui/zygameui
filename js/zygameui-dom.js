...
Window.share = function(shareData,icon,callback,extinfo,isWebPath,failCallBack) {
	...
	haxe_Log.trace("query:",{ fileName : "src/Window.hx", lineNumber : 326, className : "Window", methodName : "share", customParams : [param]});
	window.addEventListener("focus",Window.onShareFocus);
};
Window.onShareFocus = function(_) {
	haxe_Log.trace("分享回调！",{ fileName : "src/Window.hx", lineNumber : 331, className : "Window", methodName : "onShareFocus"});
