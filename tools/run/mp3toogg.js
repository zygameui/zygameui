...
ogg_Mp3ToOgg.main = function() {
	...
	while(ogg_Mp3ToOgg.thridCounts != 0) {
	}
};
...
ogg_Mp3ToOgg.ffmpeg = function(path) {
	...
	haxe_Log.trace(__filename,{ fileName : "src/ogg/Mp3ToOgg.hx", lineNumber : 49, className : "ogg.Mp3ToOgg", methodName : "ffmpeg", customParams : [process.cwd()]});
	...
	js_node_ChildProcess.exec(command,function(e,i,o) {
		...
		haxe_Log.trace("已完成" + path + "(" + ogg_Mp3ToOgg.okCounts + ")",{ fileName : "src/ogg/Mp3ToOgg.hx", lineNumber : 55, className : "ogg.Mp3ToOgg", methodName : "ffmpeg"});
		ogg_Mp3ToOgg.thridCounts--;
