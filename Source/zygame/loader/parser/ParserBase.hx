 ...
 * 基础解析器
 */
@:keep class ParserBase {
	private var _data:Dynamic;

	private var _assets:ZAssets;
	 ...
	 * @return Dynamic
	 */
	public function getAssets():ZAssets {
		return _assets;
	}
	 ...
	 */
	public function load(assets:ZAssets):Void {
		_assets = assets;
		this.process();
	}
	 ...
	 * @param pro
	 */
	dynamic public function out(parser:ParserBase, type:AssetsType, assetsData:Dynamic, pro:Float):Void {}
