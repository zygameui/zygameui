...
abstract Vec2(IVec.BaseVec) from IVec.BaseVec to IVec.BaseVec {
	...
	@:op(A / B) static function div2(a:Vec2, b:Dynamic):Vec2 {
		return a;
	};
	...
	@:op(A /= B) static function assignDiv2(a:Vec2, b:Dynamic):Vec2 {
		return a;
	};
	...
	@:op(A * B) static function multiply2(a:Vec2, b:Dynamic):Vec2 {
		return a;
	};
	...
	@:op(A *= B) static function assignMultiply2(a:Vec2, b:Dynamic):Vec2 {
		return a;
	};
	...
	@:op(A += B) static function assignAdd2(a:Vec2, b:Dynamic):Vec2 {
		return a;
	};
	...
	@:op(A -= B) static function assignSub2(a:Vec2, b:Dynamic):Vec2 {
		return a;
	};
	...
	@:op(A + B) static function add2(a:Vec2, b:Dynamic):Vec2 {
		return a;
	};
	...
	@:op(A - B) static function sub2(a:Vec2, b:Dynamic):Vec2 {
		return a;
	};
}
